...
namespace prep.specs
{
  ...
  public class MovieLibrarySpecs
  {
    ...
    public class when_searching_for_movies : concern_for_searching_and_sorting
    {
      ...
      {
        var criteria = Match<Movie>.with(x => x.production_studio).equal_to(ProductionStudio.Pixar);
      ...
      {
        var criteria = Match<Movie>.with(x => x.production_studio)
      ...
      {
        var criteria = Match<Movie>.with(x => x.production_studio).not.equal_to(ProductionStudio.Pixar);
      ...
      {
        var criteria = Match<Movie>.with(x => x.date_published).greater_than(2004);
      ...
      {
        var criteria = Match<Movie>.with(x => x.date_published.Year).between(1982,2003);
      ...
      {
        var criteria = Match<Movie>.with(x => x.genre).equal_to(Genre.kids);
      ...
      {
        var criteria = Match<Movie>.with(x => x.genre).equal_to(Genre.action);
